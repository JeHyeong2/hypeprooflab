---
title: "Your Choices Already Know the Answer"
creator: "Ryan"
creatorImage: "/members/ryan.png"
date: 2026-03-23
category: "AI × Philosophy"
tags: ["identity", "decision-making", "magnetization", "AI", "physics", "psychology", "open-source"]
slug: "2026-03-23-identity-compass"
readTime: "10 min"
excerpt: "Hundreds of small choices already contain a pattern. Nobody was tracking it — until now. The story of an 'AI life compass' borrowed from the physics of Magnetization."
lang: "en"
authorType: "creator"
---
...
In physics, there's a phenomenon called [Magnetization](https://en.wikipedia.org/wiki/Magnetization). Countless tiny magnets point in random directions until an external field aligns them into a single direction.
...
[Identity Compass](https://github.com/ico1036/identity-compass) takes a different approach. Through conversation, it records the preferences and rejections you unconsciously reveal as **beads**.

"I'd rather build my own path than follow someone else's" → one autonomy bead.
"The pay is good but you're just doing what you're told" → one anti-bead.
"Honestly, I'm jealous of that person" → one direction bead.
...
> "If you go to Company A, your alignment score rises from 0.68 to 0.72.
> Company B drops it to 0.61.
> A isn't 'better' — A is **more you.**"
...
A compass doesn't tell you where to go.
It shows you where you were already heading.
