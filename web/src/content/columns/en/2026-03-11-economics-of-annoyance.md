---
title: "The Economics of Annoyance: Can the Services You Use Survive the AI Age?"
creator: "Ryan"
date: "2026-03-11"
category: "Opinion"
tags: ["AI", "SaaS", "economics of annoyance", "responsibility", "framework"]
slug: "2026-03-11-economics-of-annoyance"
readTime: "15 min"
excerpt: "AI doesn't get annoyed. So will every business built on solving human annoyance disappear? A conclusion drawn from 30 expert perspectives and 1,400+ arguments."
creatorImage: "/members/ryan.png"
---

The services we use every day — food delivery apps, tax accountants, insurance agents, search engines, Slack, Notion — share one thing in common. They feed on human annoyance.

Insurance comparison sites handle the annoyance of comparing twenty providers. Tax accountants absorb the annoyance of filing complex returns. Zapier automates the annoyance of connecting app to app.

Then AI arrived, and a fundamental question emerged.
...
**① Comparison annoyance** — "I don't want to compare quotes from twenty insurers one by one" → comparison sites, travel metasearch (Skyscanner), price comparison apps

**② Repetition annoyance** — "Renewing, canceling, searching again every month is tedious" → the entire subscription economy. Netflix to Zapier. Set it once and inertia keeps you paying.

**③ Complexity annoyance** — "Tax filing and legal review are too complicated — I want an expert to handle it" → accountants, lawyers, insurance agents, real estate brokers, financial advisors

AI agents feel none of these. They can run 100,000 comparisons without fatigue, repeat daily without irritation, and process tax code no matter how convoluted.
...
When the tax audit comes, you can say: "My accountant handled it."
...
- **Layer 7 — Existential**: "Is my life heading the right direction?" → Irreplaceable
- **Layer 6 — Emotional**: "Someone to reassure me when I'm anxious" → Extremely difficult
- **Layer 5 — Relational**: "Contextual trust built over years" → Hard to replace
- **Layer 4 — Cognitive**: "Complex judgment on my behalf" → Partially replaceable
- **Layer 3 — Procedural**: "Managing processes for me" → Replaceable
...
- **Network density** — How complex are the multi-party interconnections?
- **Regulatory complexity** — How high are regulatory barriers to entry?
...
1. "If this business vanishes, who do I call when something goes wrong?"
2. "Would transferring this business's responsibilities to AI require changing the law?"
3. "If this business disappears, do connected systems break?"
4. "Is there something humans do in this business that AI absolutely cannot?"
5. "Are customers paying for the relationship, not just the service?"
...
**Counterargument 3: Network-based businesses** — Adding a network density axis to the Diamond was a structural fix, but the possibility that AI reshapes network effects themselves remains an open question.
...
**Step 1 — Quick screen**: "If this business disappears, who do I call when something goes wrong?" No answer? Red flag.
